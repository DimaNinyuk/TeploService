...
namespace TeploServices.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ServiceId,Name,Price,Text,TypesId,Photo")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ServiceId,Name,Price,Text,TypesId,Photo")] Service service)
        {
            if (ModelState.IsValid)
            {
